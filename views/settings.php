	...
	<div class="wpmm-wrapper">
		<div id="content" class="wrapper-cell">
			<div class="nav-tab-wrapper">
				<a class="nav-tab nav-tab-active" href="#general"><?php esc_html_e( 'General', 'wp-maintenance-mode' ); ?></a>
				<a class="nav-tab" href="#design"><?php esc_html_e( 'Design', 'wp-maintenance-mode' ); ?></a>
				<a class="nav-tab" href="#modules"><?php esc_html_e( 'Modules', 'wp-maintenance-mode' ); ?></a>
				<a class="nav-tab" href="#bot"><?php esc_html_e( 'Manage Bot', 'wp-maintenance-mode' ); ?></a>
				<a class="nav-tab" href="#gdpr"><?php esc_html_e( 'GDPR', 'wp-maintenance-mode' ); ?></a>
			</div>
				...
				<div id="tab-general" class="">
					<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" >
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[general][status]"><?php esc_html_e( 'Status', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[general][bypass_bots]"><?php esc_html_e( 'Bypass for Search Bots', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[general][backend_role][]"><?php esc_html_e( 'Backend Role', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[general][frontend_role][]"><?php esc_html_e( 'Frontend Role', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[general][meta_robots]"><?php esc_html_e( 'Robots Meta Tag', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[general][redirection]"><?php esc_html_e( 'Redirection', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[general][exclude]"><?php esc_html_e( 'Exclude', 'wp-maintenance-mode' ); ?></label></th>
									<td>
										<?php
								...
								<tr valign="top">
									<th scope="row"><label for="options[general][notice]"><?php esc_html_e( 'Notice', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[general][admin_link]"><?php esc_html_e( 'Dashboard link', 'wp-maintenance-mode' ); ?></label></th>
									<td>
				...
				<div id="tab-design" class="hidden">
					<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[design][title]"><?php esc_html_e( 'Title (HTML tag)', 'wp-maintenance-mode' ); ?></label></th>
									<td>
										<input type="text" value="<?php echo esc_attr( $this->plugin_settings['design']['title'] ); ?>" name="options[design][title]" />
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><label for="options[design][heading]"><?php esc_html_e( 'Heading', 'wp-maintenance-mode' ); ?></label></th>
								...
								<tr valign="top">
									<th scope="row"><label for="options[design][text]"><?php esc_html_e( 'Text', 'wp-maintenance-mode' ); ?></label></th>
									<td>
										<?php
										wp_editor(
								...
								<tr valign="top">
									<th scope="row"><label for="options[design][footer_links_color]"><?php esc_html_e( 'Footer links', 'wp-maintenance-mode' ); ?></label></th>
									<td>
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[design][bg_type]"><?php esc_html_e( 'Choose type', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top" class="design_bg_types <?php echo $this->plugin_settings['design']['bg_type'] !== 'color' ? 'hidden' : ''; ?>" id="show_color">
									<th scope="row"><label for="options[design][bg_color]"><?php esc_html_e( 'Choose color', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top" class="design_bg_types <?php echo $this->plugin_settings['design']['bg_type'] !== 'custom' ? 'hidden' : ''; ?>" id="show_custom">
									<th scope="row"><label for="options[design][bg_custom]"><?php esc_html_e( 'Upload background', 'wp-maintenance-mode' ); ?></label></th>
									<td>
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[design][other_custom_css]"><?php esc_html_e( 'Custom CSS', 'wp-maintenance-mode' ); ?></label></th>
									<td>
				...
				<div id="tab-modules" class="hidden">
					<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[modules][countdown_status]"><?php esc_html_e( 'Show countdown?', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][countdown_start]"><?php esc_html_e( 'Start date', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][countdown_details]"><?php esc_html_e( 'Countdown (remaining time)', 'wp-maintenance-mode' ); ?></label></th>
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][countdown_color]"><?php esc_html_e( 'Color', 'wp-maintenance-mode' ); ?></label></th>
									<td>
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[modules][subscribe_status]"><?php esc_html_e( 'Show subscribe?', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][subscribe_text]"><?php esc_html_e( 'Text', 'wp-maintenance-mode' ); ?></label></th>
									<td class="has-inline-color-picker">
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][stats]"><?php esc_html_e( 'Stats', 'wp-maintenance-mode' ); ?></label></th>
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[modules][social_status]"><?php esc_html_e( 'Show social networks?', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][social_target]"><?php esc_html_e( 'Links target?', 'wp-maintenance-mode' ); ?></label></th>
									<td>
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[modules][contact_status]"><?php esc_html_e( 'Show contact?', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][contact_email]"><?php esc_html_e( 'Email address', 'wp-maintenance-mode' ); ?></label></th>
									<td>
										<input type="text" value="<?php echo esc_attr( $this->plugin_settings['modules']['contact_email'] ); ?>" name="options[modules][contact_email]" />
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><label for="options[modules][contact_effects]"><?php esc_html_e( 'Effects', 'wp-maintenance-mode' ); ?></label></th>
									<td>
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[modules][ga_status]"><?php esc_html_e( 'Use Google Analytics?', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][ga_anonymize_ip]"><?php esc_html_e( 'Enable IP anonymization?', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[modules][ga_code]"><?php esc_html_e( 'Tracking code', 'wp-maintenance-mode' ); ?></label></th>
									<td>
					...
					<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
						<table class="form-table">
							<tbody>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][name]"><?php esc_html_e( 'Bot Name', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][avatar]"><?php esc_html_e( 'Upload avatar', 'wp-maintenance-mode' ); ?></label></th>
									<td>
						...
						<table class="form-table">
							<tbody>
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][01]"><?php esc_html_e( 'Message 1', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][02]"><?php esc_html_e( 'Message 2', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][03]"><?php esc_html_e( 'Message 3', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][responses][01]"><?php esc_html_e( 'Response', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][04]"><?php esc_html_e( 'Message 4', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][05]"><?php esc_html_e( 'Message 5', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][06]"><?php esc_html_e( 'Message 6', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][07]"><?php esc_html_e( 'Message 7', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][responses][02_1]"><?php esc_html_e( 'Response', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][08_1]"><?php esc_html_e( 'Message 8', 'wp-maintenance-mode' ); ?><br><small><?php esc_html_e( '(click on button one)', 'wp-maintenance-mode' ); ?></small></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][responses][03]"><?php esc_html_e( 'Response', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][08_2]"><?php esc_html_e( 'Message 8', 'wp-maintenance-mode' ); ?><br><small><?php esc_html_e( '(click on button two)', 'wp-maintenance-mode' ); ?></small></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][09]"><?php esc_html_e( 'Message 9', 'wp-maintenance-mode' ); ?><br><small><?php esc_html_e( '(click on button one)', 'wp-maintenance-mode' ); ?></small></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[bot][messages][10]"><?php esc_html_e( 'Message 10', 'wp-maintenance-mode' ); ?><br><small><?php esc_html_e( '(click on button one)', 'wp-maintenance-mode' ); ?></small></label></th>
									<td>
					...
					<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
						<table class="form-table">
							<tbody>
								...
								<tr valign="top">
									<th scope="row"><label for="options[gdpr][status]"><?php esc_html_e( 'Status', 'wp-maintenance-mode' ); ?></label></th>
									<td>
								...
								<tr valign="top">
									<th scope="row"><label for="options[gdpr][policy_page_target]"><?php esc_html_e( 'P. Policy link target', 'wp-maintenance-mode' ); ?></label></th>
									<td>
