                                    ...
                                    <td>
                                        <select name="options[design][page_id]" id="design_page_id">
											...
											foreach ( $pages as $page ) {
												?><option value="<?php echo $page->ID; ?>" <?php selected( $this->plugin_settings['design']['page_id'], $page->ID ); ?>><?php echo esc_html( $page->post_title ); ?></option><?php
											} ?>
                                        </select>
                                        <a href="<?php echo get_edit_post_link( $this->plugin_settings['design']['page_id'] ); ?>"><?php esc_html_e( 'Edit page', 'wp-maintenance-wp' ); ?></a>
                                        <p class="description"><?php esc_html_e( 'Select the page that will be used as your maintenance or coming soon page', 'wp-maintenance-wp' ) ?></p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
