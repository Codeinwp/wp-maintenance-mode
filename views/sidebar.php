    ...
    <div class="sidebar_box info_box">
        ...
        <div class="inside">
            ...
            <ul>
                ...
                <li><?php _e('Website', $this->plugin_slug); ?>: <?php echo!empty($plugin_data['AuthorURI']) ? '<a href="' . esc_url($plugin_data['AuthorURI'] . WPMM_AUTHOR_UTM) . '" target="_blank">' . esc_html($plugin_data['AuthorName']) . '</a>' : ''; ?></li>
                <li><?php _e('Twitter', $this->plugin_slug); ?>: <?php echo!empty($plugin_data['Twitter']) ? '<a href="' . esc_url('http://twitter.com/' . $plugin_data['Twitter']) . '" target="_blank">@' . esc_html($plugin_data['Twitter']) . '</a>' : ''; ?></li>
                <li><?php _e('GitHub', $this->plugin_slug); ?>: <?php echo!empty($plugin_data['GitHub Plugin URI']) ? '<a href="' . esc_url($plugin_data['GitHub Plugin URI']) . '" target="_blank">' . esc_html(basename($plugin_data['GitHub Plugin URI'])) . '</a>' : ''; ?></li>
            </ul>
        </div>
    </div>
