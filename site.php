...
<body>
	...
	?>
		...
		<script type="text/javascript" src="<?php echo WPMaintenanceMode::get_plugins_url( 'js/jquery.plugin.min.js', __FILE__ ); ?>"></script>
		<script type="text/javascript" src="<?php echo WPMaintenanceMode::get_plugins_url( 'js/jquery.countdown.min.js', __FILE__ ); ?>"></script>
